...
const i18n = {
  en: {
    ...
    "performance.latencyValue": "~0.15s",
    "performance.latency": "Average response time",
    ...
    "performance.note": "Internally measured in June 2026 with 1,000 real prompts.",
    ...
    "apps.title": "VIEVOT starts with two focused products.",
    "status.beta": "beta",
    ...
    "contact.body": "For general questions, beta access, or partnerships, contact the VIEVOT team.",
    "contact.note": "Email contact is being provisioned.",
  ...
  vi: {
    ...
    "nav.home": "Trang chủ",
    "navVievotChat": "Trò chuyện với VIEVOT",
    "nav.about": "Về VIEVOT",
    "nav.vieracore": "VieraCore",
    "nav.beta": "Beta Access",
    "nav.api": "API",
    ...
    "performance.latencyValue": "~0,15s",
    "performance.latency": "Thời gian phản hồi trung bình",
    ...
    "performance.note": "Đo nội bộ tháng 6/2026 với 1.000 câu hỏi thực tế.",
    ...
    "apps.title": "VIEVOT tập trung trước vào hai sản phẩm chính.",
    "status.beta": "beta",
    ...
    "contact.body": "Nếu cần hỏi chung, đăng ký beta hoặc trao đổi hợp tác, hãy liên hệ VIEVOT.",
    "contact.note": "Email liên hệ đang được khởi tạo.",
